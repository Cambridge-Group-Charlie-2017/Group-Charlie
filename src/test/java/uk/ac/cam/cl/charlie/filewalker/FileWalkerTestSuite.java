...
public class FileWalkerTestSuite {
    ...
    public void addAndChangeFiles() throws IOException {
        ...
        // appending file 101.txt to end of 100.txt, expecting the vector for
        // text 100.txt to change
        File testfile = new File(ROOT + "/root1/subfolder1/100.txt");
        File appendfile = new File(ROOT + "/root1/subfolder1/101.txt");
        FileUtils.writeStringToFile(testfile, FileUtils.readFileToString(appendfile, (Charset) null), (Charset) null,
                true);
