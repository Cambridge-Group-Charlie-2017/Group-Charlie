...
Then UI is dependent on this module, so this module must be run. prior to running the UI. The entry point for the module is uk.ac.cam.cl.charlie.ui.WebUIServer.
